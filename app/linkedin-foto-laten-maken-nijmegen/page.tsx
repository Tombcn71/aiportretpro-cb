      ...
      <section className="container mx-auto px-4 py-6 text-center">
        ...
        >
          <Link href="/login?source=linkedin">
            ...
            Start je LinkedIn fotoshoot nijmegen - € 29 <ArrowRight className="ml-2 h-6 md:h-7 w-6 md:w-7" />
          </Link>
        </Button>
        ...
        <div className="fixed bottom-4 left-4 right-4 z-[2147483647] md:hidden">
          <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-3">
            <p className="text-center text-md font-bold text-gray-800 mb-4 mt-4">
              Doe direct jouw LinkedIn fotoshoot nijmegen online, makkelijk vanuit thuis zonder gedoe, voor slechts €29,-!
            </p>
            <Button
              asChild
              size="lg"
            ...
            >
              <Link href="/login?source=linkedin">
                <LinkedinIcon className="mr-2 h-5 w-5" />
                LinkedIn fotoshoot nijmegen - € 29 <ArrowRight className="ml-2 h-6 md:h-7 w-6 md:w-7" />
              </Link>
            </Button>
          </div>
        </div>
