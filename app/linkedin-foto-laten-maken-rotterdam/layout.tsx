...
export const metadata: Metadata = {
  title: "LinkedIn Foto Laten Maken Rotterdam | AI Fotoshoot €29 | 40 Professionele Foto's",
  description: "LinkedIn foto laten maken Rotterdam? ✓ AI fotoshoot 6x goedkoper dan fotograaf ✓ 40 professionele LinkedIn foto's in 15 min ✓ Perfect voor Rotterdamse professionals ✓ Binnen 15 minuten klaar",
