...
export default function LinkedInRotterdamPage() {
  ...
  return (
    <div className="min-h-screen pt-20">
      <ReviewSchema businessName="AI Portret Pro" city="Rotterdam" />
            <SchemaMarkup type="city" city="Rotterdam" url="https://aiportretpro.com/linkedin-foto-laten-maken-rotterdam" />
      <Header />
      <Breadcrumb items={[
      ...
      {/* Hero Section - Rotterdam Specific */}
      <section className="container mx-auto px-4 py-6 text-center">
        <h1 className="tracking-tight text-xl md:text-4xl font-bold mb-6 leading-tight">
          <span className="block">Professionele foto voor LinkedIn laten maken in Rotterdam? </span>
 ...
 <HowItWorks />
      ...
      <section className="container mx-auto px-4 py-16 bg-white">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Traditioneel betekende een professionele LinkedIn foto maken in Rotterdam: een fotograaf zoeken, een afspraak inplannen (vaak weken later), door de stad reizen, en €200-300 betalen voor enkele foto's. Onze AI-technologie verandert dit volledig.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <p className="text-gray-700">Geen reistijd door Rotterdam, geen parkeergedoe, geen wachten in fotostudio's. Maak je foto's tussen twee meetings door.</p>
            </div>
            
            <div>
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Kostenbesparing</h4>
              <p className="text-gray-700">€29 voor 40 foto's versus €225 gemiddeld bij Rotterdamse fotografen. Ideaal voor startups en freelancers.</p>
            </div>
            
            <div>
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Flexibiliteit</h4>
              <p className="text-gray-700">24/7 beschikbaar, perfect voor de flexibele werkstijl van moderne Rotterdamse professionals.</p>
            </div>
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Doe wat vele professionals al deden: upgrade je LinkedIn profiel met AI-gegenereerde foto's. In een stad als Rotterdam, waar innovatie en efficiëntie centraal staan, is dit de logische volgende stap voor je professionele ontwikkeling.
          </p>

          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
            <h4 className="text-xl font-semibold text-gray-900 mb-3">Start vandaag nog</h4>
            <p className="text-gray-700 mb-4">
              Sluit je aan bij Rotterdamse professionals die de voordelen van AI fotografie al ontdekten. Krijg binnen 15 minuten 40 professionele LinkedIn foto's voor slechts €29.
            </p>
      ...
      <SEOContentBlock city="Rotterdam" showLocalKeywords={true} />
