    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Professionele AI Portetfotos</h1>
          <p className="text-xl text-gray-600">Genereer 40 professionele bedrijfsportretten met AI</p>
        </div>
