  ...
  return (
    <div className="min-h-screen ">
      ...
      <section className="container mx-auto px-4 py-6 text-center">
        ...
        <div className="mb-8">
          <Link href="/pricing">
            <button className="w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto bg-orange-500 hover:bg-orange-400 text-white text-base sm:text-lg md:text-xl px-4 sm:px-2 py-4 sm:py-5 rounded-2xl transition-colors duration-200 flex items-center justify-center gap-2 sm:gap-3 shadow-lg">
